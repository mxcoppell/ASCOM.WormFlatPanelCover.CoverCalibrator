...
; Generated by Min Xie on 12/21/2020 (UTC)
;
[Setup]
AppID={{bfff8cdc-03ed-4488-8b2b-a9b8952c36f6}
AppName=ASCOM 虫子电动平场镜头盖 CoverCalibrator Driver
AppVerName=ASCOM 虫子电动平场镜头盖 CoverCalibrator Driver 1.0.1
AppVersion=1.0.1
AppPublisher=Min Xie <minxie.dallas@gmail.com>
AppPublisherURL=mailto:minxie.dallas@gmail.com
...
OutputDir="."
OutputBaseFilename="虫子电动平场镜头盖Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\CoverCalibrator\虫子电动平场镜头盖"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\CoverCalibrator\虫子电动平场镜头盖"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "I:\github\Repos\ASCOM.WormFlatPanelCover.CoverCalibrator\ASCOM.WormFlatPanelCover.CoverCalibrator\bin\Release\ASCOM.WormFlatPanelCover.CoverCalibrator.dll"; DestDir: "{app}"
Source: "I:\github\Repos\ASCOM.WormFlatPanelCover.CoverCalibrator\ASCOM.WormFlatPanelCover.CoverCalibrator\bin\Release\usb_relay_device.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "I:\github\Repos\ASCOM.WormFlatPanelCover.CoverCalibrator\ASCOM.WormFlatPanelCover.CoverCalibrator\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.WormFlatPanelCover.CoverCalibrator.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.WormFlatPanelCover.CoverCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.WormFlatPanelCover.CoverCalibrator.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.WormFlatPanelCover.CoverCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.WormFlatPanelCover.CoverCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
